  ...
  return (
    <>
      <button
        ...
        className="group flex w-60 gap-2.5 pt-3.5 pb-3.75 rounded-tr-[100px] rounded-br-[100px] items-center px-6 xl:w-69 xl:gap-3.75 xl:px-7.75 sideBarHideBtnBgHover"
      >
        <svg
          className="fill-[#828FA3] group-hover:fill-[#635FC7] transition-colors duration-200"
          width="18"
          height="16"
          viewBox="0 0 18 16"
