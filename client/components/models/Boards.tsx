      ...
      <div className="flex flex-col gap-4.75">
        ...
        <div className="flex flex-col">
          {boards.map((board) => {
            ...
            return (
              <Link
                ...
                className={`w-60 rounded-tr-[100px] rounded-br-[100px] pt-3.5 pb-3.75 xl:w-69 ${isActive ? "bg-[#635FC7]" : "bg-transparent"}`}
              >
                <div className="flex pl-6 gap-3 xl:pl-8 xl:gap-4">
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                  ...
                  <p
                    className={`${isActive ? "text-white" : "text-[#828FA3]"}`}
                  >
                    {board.title}
                  </p>
                </div>
          ...
          <button className="pt-3.5 pb-3.75 px-6 items-center flex gap-3 xl:gap-4 xl:px-8">
            ...
            <p className="text-[15px] text-[#635FC7]">+ Create New Board</p>
          </button>
        </div>
      </div>
    </>
